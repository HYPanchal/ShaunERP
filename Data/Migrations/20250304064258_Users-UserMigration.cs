...
{
    /// <inheritdoc />
    public partial class UsersUserMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Session_Company_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Company",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SystemUserRole_SystemRole_SystemRoleId",
                        column: x => x.SystemRoleId,
                        principalTable: "SystemRole",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SystemUserRole_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserModuleAccess_CompanyModule_CompanyModuleId",
                        column: x => x.CompanyModuleId,
                        principalTable: "CompanyModule",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserModuleAccess_CompanyUser_CompanyUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserRole_CompanyUser_CompanyUserId",
                        column: x => x.CompanyUserId,
                        principalTable: "CompanyUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemUserRole_SystemRoleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserModuleAccess_CompanyModuleId",
                table: "UserModuleAccess",
                column: "CompanyModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserModuleAccess_CompanyUserId",
                table: "UserModuleAccess",
                column: "CompanyUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRole_CompanyUserId",
                table: "UserRole",
                column: "CompanyUserId");
